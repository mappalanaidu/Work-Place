...
public class Test18 {
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			driver.findElement(By.xpath("//*[@text='Search YouTube']")).sendKeys("kalam sir speeches");
			w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='android.widget.TextView'][@index=1]")));
